...
#post-removal of samples that did not amplify well (see script "laikipia_mara_get_ASV_table.R")
...
save(fitGTR, file="data/laikipia_mara_ASV_phylotree_betadiv.Rdata");
